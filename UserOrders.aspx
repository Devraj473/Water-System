<%@ Page Title="My Orders" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="UserOrders.aspx.cs" Inherits="UserOrders" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                ...
                                <%# Eval("Payment_Status").ToString() == "Unpaid" ? "<span style='color: #999; font-style: italic;'>Not Available</span>" : "" %>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
